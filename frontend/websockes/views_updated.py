# matches/views.py - Actualización
...
from .utils.websocket_notifier import match_notifier  # NUEVO
...
class OpenMatchViewSet(viewsets.ModelViewSet):
    ...
    def leave(self, request, pk=None):
        ...
        # 🔥 NOTIFICAR SALIDA POR WEBSOCKET
    ...
    def cancel(self, request, pk=None):
        ...
        # 🔥 NOTIFICAR CANCELACIÓN POR WEBSOCKET
    ...
    def remove_participant(self, request, pk=None):
        ...
        # 🔥 NOTIFICAR EXPULSIÓN POR WEBSOCKET
