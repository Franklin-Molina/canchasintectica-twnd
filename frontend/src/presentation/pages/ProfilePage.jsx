...
import { useProfilePageLogic } from '../hooks/useProfilePageLogic.js'; // Importar el hook personalizado
...
function ProfilePage() {
  ...
  // Si el usuario no está cargando y no hay usuario, mostrar mensaje de no autenticado
  if (loading) {
    return <Spinner />;
  }
