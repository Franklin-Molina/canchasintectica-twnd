...
function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 py-28 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-6">
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-6">Registro de Usuario</h2>
          
          {/* Mensajes de alerta */}
          {(error || success) && (
            <div className={`flex items-start gap-3 p-4 rounded-lg mb-6 ${
              error 
                ? 'bg-red-50 border border-red-200 dark:bg-red-900/20 dark:border-red-500/30' 
              ...
              <p className={`text-sm ${error ? 'text-red-800 dark:text-red-300' : 'text-green-800 dark:text-green-300'}`}>
                {error || success}
              </p>
            </div>
          )}
        ...
        <div className="text-center text-sm text-gray-600 dark:text-gray-400">
          <p>
            ...
            <a href="#" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 hover:underline transition-colors">
